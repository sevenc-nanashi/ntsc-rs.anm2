--label:加工\削除済み
--separator:これは旧バージョンからの移行用スクリプトです。新しいスクリプトを使用してください。
--group:入力のリサイズ,false
...
--PARAMS
--filter
--description:(Deprecated) VHS-like effect, powered by ntsc-rs v{{ntscrs_version}}, written in Rust / v{{mod2_version}} / https://github.com/sevenc-nanashi/ntsc-rs.anm2
